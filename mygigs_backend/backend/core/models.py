...
class Gig(models.Model):
    ...
    creator = models.ForeignKey(ClerkUser, on_delete=models.CASCADE, related_name='gigs', null=True, blank=True)
    ...
    # date_posted = models.DateField(auto_now_add=True, help_text="The date the gig was posted.")
...
class Freelancer(models.Model):
    ...
    name = models.CharField(max_length=255, help_text="The full name of the freelancer.", null=True, blank=True)
